...
CHECKPOINT_DIR=Path("checkpoints_lstm")
...
RESULTS_FILE=RESULTS_DIR/"results_lstm.json"
...
class LSTMModel(nn.Module):
    def __init__(self, input_size):
        ...
        # 2 LSTM layers with exactly 200 hidden units each
        self.lstm = nn.LSTM(
        ...
        # A single feed-forward layer with 200 units, then the 2-class output
    ...
    def forward(self, x):
        ...
        # Extract the hidden state from the final LSTM layer
